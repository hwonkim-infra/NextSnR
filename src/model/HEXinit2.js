...
const HEXinit = (currentModel) => {
  return {
    _id: currentModel?._id || "",
      ...
      grossWeight: currentModel?.grossWeight || "",
      grossWeight_load: currentModel?.grossWeight_load || "",
      ...
      undercarriage: {
        ...
        ground_Length: currentModel?.undercarriage?.ground_Length || "",
        ground_pressure: currentModel?.undercarriage?.ground_pressure || "",
        ground_pressure_woqc:
          currentModel?.undercarriage?.ground_pressure_woqc || "",
      },
      ...
      attachments: {
        ...
        quick_coupler_weight_2:
          currentModel?.attachments?.quick_coupler_weight_2 || "",
      ...
      travel: {
        ...
        TM_1: currentModel?.travel?.TM_1 || "",
        TM_2: currentModel?.travel?.TM_2 || "",

        DP: currentModel?.travel?.DP || "",

        theta_1: currentModel?.travel?.theta_1 || "",
        theta_2: currentModel?.travel?.theta_2 || "",

        friction_surface: currentModel?.travel?.friction_surface || "",
        traction_slope: currentModel?.travel?.traction_slope || "",
        greadability_ref: currentModel?.travel?.greadability_ref || "",
        brake_torque: currentModel?.travel?.brake_torque || "",

        travel_speed: currentModel?.travel?.travel_speed || "",
        greadability: currentModel?.travel?.greadability || "",
      },
      ...
      transport: {
        transport_1: currentModel?.transport?.transport_1 || "",
        transport_1_height: currentModel?.transport?.transport_1_height || "",
        transport_2: currentModel?.transport?.transport_2 || "",
        transport_2_height: currentModel?.transport?.transport_2_height || "",
        transport_2_weight: currentModel?.transport?.transport_2_weight || "",
        transport_3: currentModel?.transport?.transport_3 || "",
        transport_3_height: currentModel?.transport?.transport_3_height || "",
        transport_3_weight: currentModel?.transport?.transport_3_weight || "",
        transport_4: currentModel?.transport?.transport_4 || "",
        transport_4_height: currentModel?.transport?.transport_4_height || "",
        transport_4_weight: currentModel?.transport?.transport_4_weight || "",
        transport_5: currentModel?.transport?.transport_5 || "",
        transport_5_height: currentModel?.transport?.transport_5_height || "",
        transport_5_weight: currentModel?.transport?.transport_5_weight || "",
      },
