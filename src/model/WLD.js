...
const WLDSchema = new Schema({
    ...
    attachments: {
        ...
        // 작업반경
        dump_reach: Number,
        dump_angle_lift: Number,    // 전경각
        rack_angle_carry: Number,    // 후경각
        level_bucket_clearance: Number,    // 덤프높이
        bucket_reach: Number,    // 덤프거리
...
/* const WLD = mongoose.model('WLD', WLDSchema);
export default WLD */

export default models.WLD || model("WLD", WLDSchema);
