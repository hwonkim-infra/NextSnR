...
const Dimensions = ({control}) => {
  ...
  const InputForms = [
    ...
    {label: "최저지상고", name: "undercarriage.ground_clearance", type: "number", unit: "㎜"},
    {label: "후방선회반경", name: "rear_swing_radius", type: "number", unit: "㎜"},
    {label: "배토판너비x높이", name: "undercarriage.dozer_size", type: "number", unit: "㎜x㎜"},
  ] 
