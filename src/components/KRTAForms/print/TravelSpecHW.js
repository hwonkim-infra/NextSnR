...
const TravelSpecHW = ({ values, config }) => {
  const travel_speed_description =
    values.travel?.travel_speed_description || "";
          ...
          <tbody>
            <tr>
              <td className={styles.head_description}>
                ...
                <br />
                <p>○ 주행 성능 관련 사양</p>
                <table style={{ width: "80%", height: "30%", margin: "auto" }}>
                  <thead>
                    <tr>
                      <th>항목</th>
                      <th>기호</th>
                ...
                <table style={{ width: "100%", height: "40%", margin: "auto" }}>
                  <tbody>
                    <tr>
                      <TableCell colSpan="3">주행모터 축 회전수(rpm)</TableCell>
                    </tr>
                    <tr style={{ height: "40%" }}>
                      <td>
            ...
            <tr>
              <td>
                <Box sx={{ p: 1 }}>
                  ...
                  {parse(travel_speed_description)}
                </Box>
              </td>
            </tr>
          </tbody>
