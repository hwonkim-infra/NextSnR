...
const TravelSlopeWX = ({ values, config }) => {
  ...
  const greadability_description =
    values.travel?.greadability_description || "";
  ...
  return (
    <>
            ...
            <tr>
              <td className={styles.head_description}>
                <p>
                  ...
                  기울기의 견고한 건조 지면을 올라갈 수 있고, 정지상태를 유지할
                  수 있는 제동장치 및 제동장금장치를 갖추어야 한다.
                </p>
                <br />
                <p>○ 등판능력 관련 제원</p>
                ...
                <table style={{ width: "90%", height: "30%", margin: "auto" }}>
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <InlineMath>{` \\mu \\cdot W_T \\cdot \\cos \\theta_1 = W_T \\cdot \\sin \\theta_1 `}</InlineMath>
                      </td>
                      <td>
                        <InlineMath>{` \\theta_1 = \\tan^{-1} 0.90 `}</InlineMath>
                      </td>
                      <td>
                        <BlockMath>{` ${noslip_slope} `}</BlockMath>
                      </td>
                    </tr>
                    <tr>
                      <TableCell colSpan="3">
                    ...
                    <tr>
                      ...
                      <td>
                        <InlineMath>{` \\theta_2 = \\sin ^{-1} \\cfrac{${values.travel?.traction_force} - ${values.travel?.running_resist} \\cdot ${values.grossWeight}}{${values.grossWeight}} `}</InlineMath>
                      </td>

                      <td>
                        <BlockMath>{` ${traction_slope} `}</BlockMath>
                      </td>
                    </tr>
                    <tr>
                      <TableCell colSpan="3">
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <BlockMath>{` ${values.travel?.engine_slope} `}</BlockMath>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr style={{ background: "#e6e6e6" }}>
                      <TableCell colSpan="2">
                        위 3 가지 경사각 사양 중 가장 작은 값
                      </TableCell>
                      <td>
                        <BlockMath>{` ${min_slope} `}</BlockMath>
                      </td>
                    </tr>
                  </tbody>
                </table>
      ...
      {values.travel?.greadability_tested && (
        <div className={styles.pages}>
          <table className={styles.borderTable}>
            <thead>
              <tr>
              ...
              <tr>
                <Box sx={{ p: 1 }}>
                  <Typography variant="h7">
                    ...
                    {values.travel?.greadability_tested} 도{" "}
                  </Typography>
                </Box>
