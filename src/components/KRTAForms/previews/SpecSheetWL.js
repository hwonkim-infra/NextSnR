...
export default function SpecSheetWL({ values }) {
        ...
        <Table width="100%">
          <TableBody>
            ...
            <TableRow>
              ...
              <td>윤거(1)/(2)(㎜)</td>
              <td>
                {values.undercarriage?.axle_track_front} /{" "}
                {values.undercarriage?.axle_track_rear}
              </td>
            </TableRow>
            <TableRow>
              <td>높이 (㎜)</td>
            ...
            <TableRow>
              <td>버켓전경각 (°)</td>
              <td>{values.attachments?.dump_angle_lift}</td>
              <td>버켓후경각 (°)</td>
              <td>{values.attachments?.rack_angle_carry} </td>
            </TableRow>
            <TableRow>
              <td>최대덤프높이 (㎜)</td>
              <td>{values.attachments?.level_bucket_clearance} </td>
              <td>덤프거리 (㎜)</td>
              <td>{values.undercarriage?.bucket_reach}</td>
            </TableRow>
