...
export const HEXCalc = (values) => {
  ...
  return (
    (HEXCalc.grossWeight = grossWeight),
    (HEXCalc.bucket_exca_capa = bucket_exca_capa),
    (HEXCalc.grossWeight_load = grossWeight_load),
    (HEXCalc.ground_Length = ground_Length),
    (HEXCalc.ground_pressure = ground_pressure),
    (HEXCalc.ground_pressure_woqc = ground_pressure_woqc),
    (HEXCalc.swing_rev = swing_rev),
    (HEXCalc.TM_rev_1 = TM_rev_1),
    (HEXCalc.TM_rev_2 = TM_rev_2),
    (HEXCalc.TM_1 = TM_1),
    (HEXCalc.TM_2 = TM_2),
    (HEXCalc.DP = DP),
    (HEXCalc.travel_speed_1 = travel_speed_1),
    (HEXCalc.travel_speed_2 = travel_speed_2),
    (HEXCalc.travel_speed = travel_speed),
    (HEXCalc.theta_1 = theta_1),
    (HEXCalc.theta_2 = theta_2),
    (HEXCalc.traction_slope = traction_slope),
    (HEXCalc.greadability = greadability),
    (HEXCalc.transport_1_weight = transport_1_weight),
    ""
  );
};

export const HEXSave = ({ values, HEXCalc }) => {
  return (
    (values.grossWeight = HEXCalc.grossWeight),
    (values.attachments.bucket_exca_capa = HEXCalc.bucket_exca_capa),
    ""
  );
};
